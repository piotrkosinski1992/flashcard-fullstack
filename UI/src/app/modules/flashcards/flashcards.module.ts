...
@NgModule({
  declarations: [FlashcardsComponent, FlashcardsListComponent, FlashcardItemComponent, FlashcardEditComponent, FlashcardsUploadComponent, FlashcardsCreateComponent, FlashcardGroupComponent, FlashcardGroupItemComponent, FlashcardGroupCreateComponent],
  imports: [
    CommonModule,
